...
namespace LEARNING_WINDOWS_FORMS_ADVANCE_20_ {
    ...
    public partial class MyDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(System.Guid Id, int Age, bool IsActive, string Username, string Password, string FullName, string EmailAddress) {
...
namespace LEARNING_WINDOWS_FORMS_ADVANCE_20_.MyDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([Id] = @Original_Id) AND ([Age] = @Original_Age) AND ([IsActive] = @Original_IsActive) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ([EmailAddress] = @Original_EmailAddress))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([Id], [Age], [IsActive], [Username], [Password], [FullName], [EmailAddress]) VALUES (@Id, @Age, @IsActive, @Username, @Password, @FullName, @EmailAddress);
SELECT Id, Age, IsActive, Username, Password, FullName, EmailAddress FROM Users WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Id] = @Id, [Age] = @Age, [IsActive] = @IsActive, [Username] = @Username, [Password] = @Password, [FullName] = @FullName, [EmailAddress] = @EmailAddress WHERE (([Id] = @Original_Id) AND ([Age] = @Original_Age) AND ([IsActive] = @Original_IsActive) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ([EmailAddress] = @Original_EmailAddress));
SELECT Id, Age, IsActive, Username, Password, FullName, EmailAddress FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=.;Initial Catalog=test;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Age, IsActive, Username, Password, FullName, EmailAddress FROM dbo.Use" +
                "rs";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Id, Age, IsActive, Username, Password, FullName, EmailAddress\r\nFROM" +
            ...
            this._commandCollection[2].CommandText = "SELECT        Id, Age, IsActive, Username, Password, FullName, EmailAddress\r\nFROM" +
        ...
        public virtual int FillByPassword(MyDataSet.UsersDataTable dataTable, string Password) {
        ...
        public virtual MyDataSet.UsersDataTable GetDataByPassword(string Password) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Password == null)) {
                throw new global::System.ArgumentNullException("Password");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByUserName(MyDataSet.UsersDataTable dataTable, string Username) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual MyDataSet.UsersDataTable GetDataByUserName(string Username) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
        ...
        public virtual int Delete(System.Guid Original_Id, int Original_Age, bool Original_IsActive, string Original_Username, string Original_Password, string Original_FullName, string Original_EmailAddress) {
        ...
        public virtual int Insert(System.Guid Id, int Age, bool IsActive, string Username, string Password, string FullName, string EmailAddress) {
        ...
        public virtual int Update(System.Guid Id, int Age, bool IsActive, string Username, string Password, string FullName, string EmailAddress, System.Guid Original_Id, int Original_Age, bool Original_IsActive, string Original_Username, string Original_Password, string Original_FullName, string Original_EmailAddress) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Age, bool IsActive, string Username, string Password, string FullName, string EmailAddress, System.Guid Original_Id, int Original_Age, bool Original_IsActive, string Original_Username, string Original_Password, string Original_FullName, string Original_EmailAddress) {
            return this.Update(Original_Id, Age, IsActive, Username, Password, FullName, EmailAddress, Original_Id, Original_Age, Original_IsActive, Original_Username, Original_Password, Original_FullName, Original_EmailAddress);
        }
    }
